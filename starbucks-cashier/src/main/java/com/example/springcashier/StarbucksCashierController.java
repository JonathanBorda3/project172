...
import com.example.springcashier.model.Command;
...
public class StarbucksCashierController {
    ...
    @Autowired
    public StarbucksCashierController(OrderQueryRepository orderRepository, OrderModelRepository orderModelRepository) {
